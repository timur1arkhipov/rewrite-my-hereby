export interface TaskOptions {
    ...
    /**
     * If true, this task will be hidden from `tereby --tasks`.
     */
    hiddenFromTaskList?: boolean | undefined;
}

/**
 * A tereby Task. To get an instance, call `test`.
 */
export class Task {
    ...
    private constructor(options: TaskOptions) {
        // Runtime typecheck; consumers of tereby may not have enabled
